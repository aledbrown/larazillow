        ...
        <Box v-for="listing in listings.data" :key="listing.id" :class="{ 'border-dashed': listing.deleted_at }">
            <div class="flex flex-col md:flex-row gap-2 md:items-center justify-between">
                ...
                <section>
                    ...
                    <div class="mt-2">
                        <Link :href="route('agent.listing.image.create', { listing: listing.id })" class="block w-full btn-outline text-xs font-medium text-center">Images ({{ listing.images_count }})</Link>
                    </div>
                </section>
            </div>
        </Box>
...
import AgentFilters from "@/Pages/Agent/Index/Components/AgentFilters.vue";
