<template>
    <form @submit.prevent="create">
        <div class="grid grid-cols-6 gap-4">
            ...
            <div class="col-span-2">
                <label class="block mb-1 text-gray-500 dark:text-gray-300 font-medium">Area (m<sup>²</sup>)</label>
            ...
            <div class="col-span-2">
                <label class="block mb-1 text-gray-500 dark:text-gray-300 font-medium">Street Number</label>
...
const create = () => form.post(route('agent.listing.store'))
</script>
